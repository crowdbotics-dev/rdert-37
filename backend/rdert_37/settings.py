"""
Django settings for rdert_37 project.
...
WSGI_APPLICATION = 'rdert_37.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rdert_37 API",
    "DESCRIPTION": "API documentation for rdert_37 App",
    "VERSION": "v1",
}
